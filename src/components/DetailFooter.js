        ...
        <>
            <ThemeProvider theme={customTheme}>
                ...
                <Box className="footerMainBox">
                    <Grid container gap={10} className="columnFlow">

                        <Grid container item className="centeredText">

                            <Grid item gap={2} xs={6} sm={5} md={2} lg={2} className="columnFlow" justifyContent="center" textAlign="left">
                            ...
                            <Grid item gap={1} xs={5} sm={5} md={2} lg={2} textAlign="left" className="columnFlow">

                                <Typography variant="h6">Author</Typography>
                                <Typography variant="body1">Paweł Gawrych</Typography>
                            </Grid>
                        
                            <Grid item gap={1} xs={11} sm={5} md={3} lg={3} textAlign="left" className="columnFlow">
                        ...
                        <Grid container gap={5} item alignItems="right" className="centeredText">

                            <Grid item gap={1} xs={11} sm={11} md={11} lg={5} textAlign="left" className="columnFlow">
